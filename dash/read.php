    ...
    <div class="container">
      <div class="row animate-box">
        <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
          <h2>Read More | <a href="index.php">Back</a></h2>
        </div>
      </div>
      <?php
      ...
      <div class="row">
            ...
            <a class="btn btn-primary" href="editpost.php?read=view&id=<?php echo $key['id'] ?>">Edit Post</a>
          </div>
          <div style="padding-bottom: 30px;" class="col-lg-7 col-md-8 pull-right">
          <div class="fh5co-blog animate-box">
            <div class="blog-text">
              <h3><?php echo $key['title'] ?></h3>
              <p><?php echo $key['subject'] ?></p>
              <p><?php echo $key['conclusion'] ?></p>
              <span class="posted_on"><?php echo date("F j, Y ", strtotime($key["posted_at"])); ?></span>
              <form class="" action="" method="post" enctype="multipart/form-data">
                <button class="btn btn-danger fa fa-trash pull-right" type="submit" name="delete"> Delete</button>
              </form>
              <?php

...
<head>
    ...
    <title>Add Post | Petit Séminaire Saint Vincent de Ndera</title>
  ...
  <div id="fh5co-staff">
    <div class="row animate-box">
      <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
        <h2><small><a href="index.php">Blog</a></small>  / Add Member</h2>
      </div>
    </div><br><br>
    <div class="container">
      <div class="row col-md-12">
          ...
          <div class="form-group col-md-12">
            ...
            <textarea class="form-control" name="sub" rows="5" cols="80"></textarea>
          </div>
          <div class="form-group col-md-12">
            <label for="pwd">Long Description:</label>
            <textarea class="form-control" name="conclusion" rows="6" cols="30"></textarea>
          </div>
          <div class="form-group col-md-6">
            <label for="pwd">Upload Image:</label>
          <input class="form-control btn btn-default" type="file" name="image" value="">
          </div>
          <div class="form-group col-md-6">
          <button type="submit" class="btn btn-default">Reload</button>
          <button type="submit"  name="post" class="btn btn-warning">Post</button>
        </div>
        </form>
        <?php
        if (isset($_POST['post'])) {
          ...
          DB::query('INSERT INTO blog VALUES(\'\', :title,:subject,:conclusion,:image,NOW())', array(':title'=>$title,':subject'=>$sub,':conclusion'=>$conclusion,':image'=>$file));
          if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
            echo "<script>alert('Post Added Successfully!!!')</script>";
            echo "<script>window.open('addpost.php', '_self')</script>";
          }else {

  ...
  <div id="fh5co-staff">
    <div class="row animate-box">
      <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
        <h2><small><a href="index.php">Home</a></small>  / Add School Calendar PDF Document</h2>
      </div>
    </div><br><br>
    <div class="container">
      <div class="row col-md-12">
        <form class="" action="" method="post" enctype="multipart/form-data">
          ...
          <input class="form-control" placeholder="Upload File" type="file" name="image" value="">
        </div>
          <div class="form-group col-md-6"><br>
          <button type="submit" class="btn btn-default">Reload</button>
          <button type="submit" name="add" class="btn btn-success fa fa-plus"> File</button>
        </div>
        </form>
        <?php
        if (isset($_POST['add'])) {

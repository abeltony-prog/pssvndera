...
<body>
  ...
  <div id="fh5co-staff">
    ...
    <div class="container">
      <?php
      $all = DB::query('SELECT * FROM blog WHERE id=:id', array(':id'=>$_GET['id']));
      foreach ($all as $var) {
        ?>
        <div class="container">
          <div class="row col-md-12">
              ...
              <div class="form-group col-md-12">
                ...
                <input type="text" name="title" class="form-control" id="title" value="<?php echo $var['title'] ?>">
              </div>
              <div class="form-group col-md-12">
                <label for="pwd">Short Description:</label>
                <textarea class="form-control" name="sub" rows="5" cols="80" ><?php echo $var['subject'] ?></textarea>
              </div>
              <div class="form-group col-md-12">
                <label for="pwd">Long Description:</label>
                <textarea class="form-control" name="conclusion" rows="6" cols="30"><?php echo $var['conclusion'] ?></textarea>
              </div>
            ...
            if (isset($_POST['update'])) {
              ...
              DB::query('UPDATE blog SET title=:title WHERE id=id', array(':title'=>$title,':id'=>$_GET['id']));
              if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
                echo "<script>alert('Post Updated Successfully!!!')</script>";
                echo "<script>window.open('index.php', '_self')</script>";
              }else {
                echo "<span>file wasn't submited</span>";
              }
            }
             ?>
          </div>

...
<head>
    ...
    <title>Add Member | Petit Séminaire Saint Vincent de Ndera</title>
  ...
  <div id="fh5co-staff">
    <div class="row animate-box">
      <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
        <h2><small><a href="staff.php">Staff Members</a></small>  / Edit Member</h2>
      </div>
    </div><br><br>
    <div class="container">
      <?php
      $all = DB::query('SELECT * FROM staff WHERE id=:id', array(':id'=>$_GET['id']));
      foreach ($all as $var) {
        ?>
        <div class="row col-md-12">
            <form class="" action="" method="post" enctype="multipart/form-data">
            <div class="form-group col-md-6">
              <label for="email">Member Names:</label>
              <input type="text" name="name" value="<?php echo $var['name'] ?>" class="form-control" id="name">
            </div>
            <div class="form-group col-md-6">
              <label for="pwd">Title:</label>
              <input type="text" name="title" value="<?php echo $var['title'] ?>" class="form-control" id="title">
            </div>
            <div class="form-group col-md-6">
              <label for="pwd">Telephone Number:</label>
              <input type="number" name="tel" value="<?php echo $var['tel'] ?>" class="form-control" id="number">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
            <label for="pwd">select Staff:</label>
            <select class="form-control btn btn-default" name="staff">
              <option value="<?php echo $var['staff'] ?>"><?php echo $var['staff']; ?></option>
              ...
              <option value="COMITE DES PARENT">COMITE DES PARENTS</option>
            </select>
            </div>
            <div class="form-group col-md-6">
            <label for="pwd">Upload Image:</label>
            <input class="form-control btn btn-default" type="file" name="image" value="<?php echo $var['image'] ?>">
            </div>
            <div class="form-group col-md-6">
            <button type="submit" name="delete" class="btn btn-danger fa fa-trash">Delete</button>
          ...
          if (isset($_POST['update'])) {
            ...
            if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
              ...
              echo "<span>Member wasn't Added</span>";
            }
            echo "<script>alert('Staff member Updated Successfully!!!')</script>";
            echo "<script>window.open('staff.php', '_self')</script>";

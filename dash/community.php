  ...
  <div id="fh5co-staff">
    <div class="row animate-box">
      <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
        <h2><small><a href="addmember.php">Add Members</a></small>  / Add parent</h2>
      </div>
    </div><br><br>
    <div class="container">
      <div class="row col-md-12">
        <form role="form">
          <div class="form-group col-md-6">
            <label for="email">Parent Names:</label>
          ...
          <div class="form-group col-md-6">
          <input class="form-control btn btn-default" type="file" name="" value="">
          </div>
          <div class="form-group col-md-6">
          <button type="submit" class="btn btn-default">Reload</button>
          <button type="submit" class="btn btn-warning">Add Parent</button>

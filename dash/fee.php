...
<head>
    ...
    <title>Fees | Petit Séminaire Saint Vincent de Ndera</title>
...
<body>
  ...
  <div class="form-group col-md-6">
    ...
    <input type="text" name="name" class="form-control" id="fee" value="" placeholder="Name of the Bank">
  </div>
  <div class="form-group col-md-6">
    <label for="email">Code:</label>
    <input type="text" name="code" class="form-control" id="fee" value="" placeholder="Code of the Bank">
  </div>
  <div class="form-group col-md-12">
    <label for="email">Details:</label>
    <textarea class="form-control" name="details" rows="8" cols="80" placeholder="Deatils"></textarea>
  </div>
  <div class="form-group col-md-6">
  <button type="submit" class="btn btn-default">Reload</button>
  <button type="submit" name="add" class="btn btn-warning">Add Bank</button>
</div>
</form>
<?php
if (isset($_POST['add'])) {

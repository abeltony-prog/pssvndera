		...
		<div class="container">
			...
			<div class="row">
				<div class="pricing pricing--rabten">
					<?php
					$fee = DB::query('SELECT * FROM fee ORDER BY id DESC LIMIT 3');
					foreach ($fee as $f) {
						?>
							...
							<div class="pricing__item">
								<div class="wrap-price">
									 <!-- <div class="icon icon-user2"></div> -->
												 <h3 class="pricing__title"><?php echo $f['name'] ?></h3>
												 <!-- <p class="pricing__sentence">Single user license</p> -->
								</div>
											 <div class="pricing__price">
													<span class="pricing__anim pricing__anim--1">
									<span style="font-size: 30px;" class="pricing__currency"><?php echo $f['code'] ?></span>
													</span>
											 </div>
											 <div class="wrap-price">
												<ul class="pricing__feature-list">
														<li class="pricing__feature"><?php echo $f['details'] ?></li>
												 </ul>
											 </div>
										</div>
						</div>

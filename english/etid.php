        ...
        <div class="row">
					<div class="col-md-6 col-sm-12 text-center animate-box">
						<div class="services col-md-12 col-sm-12">
							<img class="services col-md-12 col-sm-12" src="../images/10.jpeg" alt="">
						</div>
					</div>
          <div class="col-md-6 col-sm-12 animate-box">
            <div class="services col-md-12 col-sm-12">
              <p style="color:black;">
								La vie intellectuelle au Petit Séminaire Saint Vincent s’appuie sur les activités académiques et
								para-académiques qui y sont organisées. En premier lieu, il y a différents cours dispensés au
								niveau de deux cycles : inferieur et supérieur, respectivement appelés Tronc Commun et Section.
								Le programme qui y est suivi est celui du ministère de l’éducation nationale : ainsi, les cours au
								Tronc Commun sont ceux exigés par le programme avec quelques cours propres au <b style="color:gray;"> séminaire,
								tels latin, musique, religion, … En section</b>	, nous avons actuellement la combinaison physique-
								chimie-mathématique <i style="color: orange;">(PCM)</i> et mathématique-chimie-biologie <i style="color: orange;" >(MCB)</i>.
							</p>
            </div>
          </div>
				</div>
					<div class="col-md-6 col-sm-12 animate-box">
						<p style="color:black;">
							Les séminaristes disposent de 40 périodes de cinquante minutes chacune par semaine : lundi,
							mardi, jeudi et vendredi sept périodes et six mercredi et samedi.
							Au palmarès de réussite interne, la situation montre que presque la totalité des élèves s’en sortent
							bien, grâce au suivi permanent de l’équipe des formateurs et professeurs.
							Quant aux examens d’état pour les deux cycles, la performance est totale : tous en division 1 au
							tronc commun et bon nombre atteignent la totalité ou presque des points en section.
							Ceci est sans doute un signe qui ne trompe pas quant à l’excellence de la formation intellectuelle
							offerte par le Petit Séminaire Saint Vincent de Ndera.
						</p>
					</div>
					<div class="col-md-6 col-sm-12 text-center animate-box">
						<div class="services col-md-12 col-sm-12">
							<img class="services col-md-12 col-sm-12" src="../images/9.jpeg" alt="">
						</div>
					</div>
        </div>
			</div>

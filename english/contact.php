					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12 text-center menu-1">
							<ul>
								...
								<li><a style="color: orange;" href="contact.php">Contact us</a></li>
							</ul>
						</div>
					</div>
					...
					<form class="" action="" method="post" enctype="multipart/form-data">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" name="sub" id="subject" class="form-control" placeholder="Subject">
							</div>
						</div>
						...
						<div class="form-group">
							<input type="submit" name="send" value="Send Message" class="btn btn-warning">
						</div>
					</form>
					<?php
						if (isset($_POST['send'])) {

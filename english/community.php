        ...
        <div class="row">
					<div class="col-md-6 col-sm-12 text-center animate-box">
						<div class="services col-md-12 col-sm-12">
							<img class="services col-md-12 col-sm-12" src="../images/terrain.jpg" alt="">
						</div>
					</div>
          <div class="col-md-6 col-sm-12 animate-box">
            <div class="services col-md-12 col-sm-12">
              <p style="color:black;">
								Le séminaire dispense une formation humaine et morale en aidant les séminaristes à cultiver en
								soi, en premier lieu, les vertus surnaturelles de foi, d’espérance et de la charité ; ensuite, les
								vertus qui sont en relation directe avec l’idéal sacerdotal, à savoir l’obéissance, la chasteté et la
								pauvreté ; et enfin, les vertus humaines et morales de justice, de prudence, de tempérance et de
								force. Cela passe par des activités de tous genres comme la vie des mouvements, des clubs, des
								formations sportives et athlétiques mais aussi par l’expérience d’une vie en communauté qui
								favorise également le développement du sens de responsabilité et d’initiative.
							</p>
            </div>
          </div>
				</div>
					<div class="col-md-6 col-sm-12 animate-box">
						<p style="color:black;">
							En plus, Le Petit Séminaire Saint Vincent offre un cadre et un environnement favorable au
							développement des talents personnels des
							<b>séminaristes, entre autre des talents sportifs,
							linguistiques, musicaux, etc.</b><br>
						  <i>
								« Les futurs prêtres doivent cultiver un ensemble de qualités humaines indispensables à la
							  construction de personnalités équilibrées, fortes et libres ; pour être capables de porter le poids
							  de responsabilités pastorales d’où la nécessité de l’éducation à l’amour de la vérité, à la
							  loyauté, au respect de toute personne ; au sens de la justice, à la fidélité, à la cohérence et en
							  particulier à l’équilibre du jugement et du comportement »
							</i>. (Jean Paul II, Exhortation
						  apostolique post-synodale. Pastores Dabo Vobis, du 25 Mars 1992, n o 43).
						</p>
					</div>
					<div class="col-md-6 col-sm-12 text-center animate-box">
						<div class="services col-md-12 col-sm-12">
							<img class="services col-md-12 col-sm-12" src="../images/dance.jpg" alt="">
						</div>
					</div>
        </div>
			</div>

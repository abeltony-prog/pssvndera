...
<html>
	...
	<div id="fh5co-pricing" class="fh5co-bg-section">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 item-center col-sm-12 animate-box">
            <div class="services col-md-12 col-sm-12">
              <p style="color:black;">
                Chers lectrices et lecteurs,<br><br>
                Bienvenue sur le site web du Petit Séminaire Saint Vincent de Ndera. Vous y découvrirez
                bien d’informations concernant la vie au séminaire surtout les activités faites en vue d’une
                bonne formation humaine, intellectuelle et spirituelle des séminaristes.<br>
                Le séminaire est un établissement scolaire pas comme les autres. En effet, ce qui fait sa
                particularité est sa mission essentielle d’être une pépinière pour des futurs prêtres et des
                chrétiens laïcs engagés dans le milieu ecclésial, politique, socio-économique et professionnel.
                Ainsi, ce site web vous partagera certains efforts et initiatives pour accomplir la tâche qui
                nous est assignée.<br>
                Nous attendons et recevrons avec grand plaisir vos conseils pour améliorer la qualité de ce
                site mais également vos suggestions sur tel ou tel aspect de la vie du séminaire sont toujours
                les bienvenues.
                Nous voudrions que tout ce qui est affiché à ce site web rende gloire au Christ qui est Vérité
                et Lumière du monde et serve à l’édification de son Eglise.<br>
                </p>
                <p style="color:black;" class="text-center">
                Que saint Vincent de Paul, notre Patron céleste, intercède pour nous.<br>

                Ad Lucem et Veritatem <br>

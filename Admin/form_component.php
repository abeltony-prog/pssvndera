        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_document_alt"></i>Posts</li>
              <li><i class="fa fa-file-text-o"></i>News</li>
            </ol>
          </div>
        </div>
                  ...
                  <div class="panel-body">
                    <div class="form">
                      ...
                      <form action="#" method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <button class="btn btn-primary pull-right mt-3" type="submit" name="post">Post</button>
                      </form>
                    </div>

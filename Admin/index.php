      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <a href="change password.php?one=view&id=<?php echo $key['id'] ?>" class="btn btn-secondary"><i class="fa fa-key"></i> Change Password</a>
            <?php
            }
           ?>
            <ol class="breadcrumb">
        ...
        <?php
        $all = DB::query('SELECT * FROM posts ORDER BY id DESC LIMIT 12');
         ?>
        <div class="row">
           <?php
           foreach ($all as $key) {
              ...
              <div class="fh5co-blog animate-box">
                ...
                <div class="blog-text">
                  ...
                  <span class="posted_on"><?php echo date("F j, Y ", strtotime($key["posted_at"])); ?></span>
                    <a class="btn btn-primary fa fa-edit" href="editpost.php?one=view&id=<?php echo $key['id'] ?>"><span>Edit</span> </a>
                    <?php

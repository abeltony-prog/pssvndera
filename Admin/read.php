    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <?php
            $titles = DB::query('SELECT * FROM posts WHERE id=:id', array(':id'=>$_GET['id']));
            foreach ($titles as $title) {
              ?>
              <h3 class="page-header"><i class="fa fa-laptop"></i> <?php echo $title['title']; ?></h3>
              <?php
            }
             ?>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.php">Go Back</a></li>
              <li><i class="fa fa-eye"></i>Read</li>
            </ol>
          </div>
        </div>
        <?php
        $read = DB::query('SELECT * FROM posts WHERE id=:id', array(':id'=>$_GET['id']));
         ?>
        <div class="row">
           <?php
           foreach ($read as $key) {
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="fh5co-blog animate-box">
                ...
                <div class="blog-text">
                  ...
                  <span style="color:orange;" class="posted_on pull-right"><?php echo date("F j, Y ", strtotime($key["posted_at"])); ?></span>
                  </form>
                </div>
            </div>
            <!--/.info-box-->
